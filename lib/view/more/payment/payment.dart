...
class _PaymentPageState extends State<PaymentPage> {
  List<String> paymentTypes = ['Due','All Payment','Payment History',];
...
final allPayment = <PaymentModel>[
   PaymentModel(date: "2022/11/22", paymentStatus: "due", amount: 22222.0, pay: ElevatedButton(onPressed: () {  },child: Text("pay"),)),
   PaymentModel(date: "2022/11/23", paymentStatus: "due", amount: 99999.0, pay: ElevatedButton(onPressed:(){},child: Text("pay"),)),
   PaymentModel(date: "2022/11/22", paymentStatus: "due", amount: 22222.0, pay: ElevatedButton(onPressed:(){},child: Text("pay"),)),
   PaymentModel(date: "2022/11/23", paymentStatus: "due", amount: 99999.0, pay: ElevatedButton(onPressed:(){},child: Text("pay"),)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: ProfileAppBarC(title: "Payment", backArrow: true,),
      body: Padding(
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text("Payment Details", style: TextStyle(fontWeight:FontWeight.bold, fontSize: 17.0)),
...
return showDialog(
  ...
  builder: (context) {
    return AlertDialog(
      title: Image(image: AssetImage("assets/image/esewa.png")),
      content: TextField(
        onChanged: (value) {
          setState(() {
            valueText = value;
